...
public class GetAllSettingsVm
{
    ...
    public TruckCrossSettingsVm TruckCrossGate { get; set; } = new();
    public List<DocumentSettingsVm> CustomerData { get; set; } = new();
    public NotificationSettingsVm Notification { get; set; } = new();
}

public class TruckCrossSettingsVm
{
...
public class DocumentSettingsVm
{
