        ...
        switch (exception)
        {
            case SqlException sqlException:
                ...
                result = JsonConvert.SerializeObject(new ApiResponse()
                {
                    ...
                    Messages = new[]
                    {
                        string.Format(TextResources.APP_StringKeys_Error_SqlException, sqlException.ErrorCode),
            ...
            case SqliteException sqliteException:
                ...
                result = JsonConvert.SerializeObject(new ApiResponse()
                {
                    ...
                    Messages = new[]
                    {
                        TextResources.APP_StringKeys_Error_SqliteException,
            ...
            case MethodExecutionFailedException methodExecutionFailedException:
                ...
                result = JsonConvert.SerializeObject(new ApiResponse()
                {
                    ...
                    Messages = new[]
                    {
                        TextResources.APP_StringKeys_Error_Unexpected
                    },
                });
