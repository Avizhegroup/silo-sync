...
public sealed class SyncTestDbContext : DbContext
{
    public SyncTestDbContext(DbContextOptions<SyncTestDbContext> options) : base(options)
    {
    }

    public DbSet<Product> Products { get; set; } = null!;
    public DbSet<SyncSourceConfig> SyncSourceConfigs { get; set; } = null!;
    public DbSet<SyncCheckpoint> SyncCheckpoints { get; set; } = null!;
    public DbSet<SyncRunLog> SyncRunLogs { get; set; } = null!;
    public DbSet<SyncRowFailure> SyncRowFailures { get; set; } = null!;
